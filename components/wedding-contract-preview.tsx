...
import { Calendar, Landmark, Mail, MapPin, Phone, User, MessageSquare } from "lucide-react";
import * as React from "react";
import type { WeddingContractSchema, SettingsSchema } from "@/lib/schema";
...
export function WeddingContractPreview({ data, settings }: WeddingContractPreviewProps) {
							...
							{(data.combos || []).map((combo, cIdx) => (
								<div key={cIdx}>
									...
									<div className="pl-3 mt-0.5 space-y-0.5">
										{combo.services.map((s: any, sIdx: number) => (
											<div
												key={sIdx}
												className={cn(
						...
						<div className="col-span-4 flex flex-col">
							...
							<div className="grid grid-cols-2 flex-1 min-h-[56px]">
								...
								<div className="flex flex-col items-center justify-center relative">
									<div className="transform -rotate-6 absolute w-20 h-14 flex items-center justify-center">
